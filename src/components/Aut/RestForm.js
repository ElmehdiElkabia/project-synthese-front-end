...
const RestForm = () => {
    return (
        <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
            ...
            <button type="submit" className="w-full text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Reset password</button>
        </form>
    );
}
